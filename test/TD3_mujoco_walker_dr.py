...
from RobustRLBenchmarks.mujoco.domainrandom.dr_walker2d import DRWalker2dEnv
...
CONFIG = {
    ...
    'noise_clip': 0.2,
    'device': 'cuda',
    'result_path': '/home/xukang/GitRepo/RobustRLBenchmarks/test/results/TD3_mujoco_walker_DR/',
    'max_steps': 1200000,
    'evaluation_interval': 50,
    'evaluation_episode': 10,
    'train_begin_episode': 50
}
...
def train(config: Dict, exp_name: str) -> None:
    train_env = DRWalker2dEnv(config['train_env_config'])
    test_env = DRWalker2dEnv(config['test_env_config'])
